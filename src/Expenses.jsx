...
function Expenses() {
  ...
  if (loading) {
    return <p style={{ color: "#c9a227" }}>Loading expenses...</p>;
  }
  ...
  return (
    <div>
      <div
        ...
        style={{ backgroundColor: "#1a472a", border: "2px solid #c9a227" }}
      >
        <p className="text-sm mb-1" style={{ color: "#f5f5f5", opacity: 0.8 }}>
          Total Expenses
        </p>
      ...
      {filteredItems.length === 0 && (
        <p style={{ color: "#f5f5f5" }}>No expenses found.</p>
      )}
      ...
      <div className="flex flex-col gap-3">
        {filteredItems.map((item) => (
          <div
            key={item._id}
            className="rounded-xl p-4 flex flex-col gap-3 sm:flex-row sm:justify-between sm:items-center"
